...
<svelte:head>
  <title>Velu S Gautam Personal Website</title>
</svelte:head>
...
<div class="container">
  ...
  <div class="content">
    <div>
      <h1>Velu S Gautam</h1>
      <p class="title">Web Engineer & Entreprenuer</p>
      <p class="description">
        I am a web engineer from India. I passionate about all innovations in
        web applications. I mostly write code in JavaScript.
      </p>
      <ul class="social">
        <li>
          <a
            href="https://twitter.com/velusgautam"
            alt="twitter"
            target="_blank">
            <svg
        ...
        <li>
          <a
            href="https://linkedin.com/in/velusgautam"
            alt="linkedin"
            target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li>
          <a href="https://github.com/velusgautam" alt="github" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
